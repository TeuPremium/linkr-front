...
export function UserPostContainer(prop){
    ...
    return(
      <>
       {deletePrompt ? <ViewPortContainer>
        <DeleteContainer>
          <div>
    ...
    <PostContainer color={"#171717"}> 
      ...
      <UsersPosts>
        ...
        <CommentContainer>
        {edit ? <form onSubmit={handleSubmit(onSubmit)}><input autoComplete="off" defaultValue={comment} {...register("comment")}/></form>: <h4>{comment}</h4>}
        </CommentContainer>
